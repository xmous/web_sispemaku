...
<div class="wrapper">
  ...
  <div class="card">
              <div class="card-header">
                ...
                <a href="{{url('user/create')}}" class="btn btn-primary btn-sm" style="float : right">Tambah Customer</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{url('user/struk/'.$d->username)}}" class="btn btn-block btn-primary btn-sm">Tambah</a>
                    </td>
                  </tr>
                  <?php $no++; ?>
                  @endforeach
