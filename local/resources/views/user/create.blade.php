                ...
                <div class="card-body">
                    {!! Form::open(['url' => 'user','files'=>true]) !!}
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    {!! Form::text('nama',null,['class'=>'input--style-5','required'=>'true']) !!}
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    {!! Form::text('username',null,['class'=>'input--style-5','required'=>'true']) !!}
                                    <!-- <input class="input--style-5" type="text" name="company"> -->
                                </div>
                            </div>
                        </div>
                        <!-- <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    {!! Form::text('password',null,['class'=>'input--style-5','required'=>'true']) !!}
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        {!! Form::select('id_pembagian',$data,null,['required'=>'true','placeholder'=>'Pilih Kota']) !!}
