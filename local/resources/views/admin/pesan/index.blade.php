          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                {!! Form::open(['url' => 'admin/pesan/search','files'=>true]) !!}
                  ...
                  <tr>
                    ...
                    <td class="text-left py-0 align-middle">
                      <div class="btn-group btn-group-sm">
                        <a href="{{url('admin/pesan/'.$d->id.'/edit')}}" class="btn btn-info fancybox fancybox.iframe"><i class="fas fa-eye"></i></a>
                        <a href="{{url('admin/pesan/delete/'.$d->id)}}" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>
                  </tr>
                  <?php $no++; ?>
